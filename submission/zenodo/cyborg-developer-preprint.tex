...
\author{Anderson Henrique da Silva~\orcidlink{0009-0001-7144-4974}\\
Neural Thinkers Lab AI Engineering LTDA\\
IFSULDEMINAS -- Campus Muzambinho\\
Minas Gerais, Brasil\\
\texttt{anderson@ntlabs.dev} \quad \href{https://ntlabs.dev}{\texttt{ntlabs.dev}}\\
\texttt{github.com/anderson-ntlabs}
}

\date{May 2026 (v1.1.0)}
...
\begin{itemize}
    \item Production systems (ProjectA-*)
    \item Research projects (ProjectD, ProjectF)
    \item Experiments (ProjectG, ProjectB)
    \item Administrative work (ProjectE, ProjectH)
\end{itemize}
...
\begin{itemize}
    \item \textbf{ProjectA-* sessions}: $D = 0.69$
    \item \textbf{Non-ProjectA sessions}: $D = 0.73$
...
\url{https://github.com/anderson-ntlabs/cyborg}
